...
C:\Users\pwned-user\Desktop\malicious-powershell.ps1                                                                                function Invoke-AESEncryption {...

PS C:\Users\nol> [string]($content | Where-Object Path -like "*malicious-powershell.ps1").Content
<script source>
```
